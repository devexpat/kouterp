...
To: {to}
cc: {cc}
Received: by mail1.Kouterp.com (Postfix, from userid 10002)
...
Received: from mail-ie0-f173.google.com (mail-ie0-f173.google.com [209.85.223.173])
    ...
    for <raoul@Kouterp.fr>; Fri, 23 Aug 2013 13:17:55 +0200 (CEST)
...
Delivered-To: anon2@gmail1.Kouterp.com
...
In-Reply-To: <829228111124527.1111111602.256611118262939-Kouterp-129-xxxx.xxxx@ip-1-1-1-1>
References: <867911111953277.1523671337.187951111160400-Kouterp-129-xxxx.xxxx@ip-1-1-1-1>
 <867911111953277.1523671337.256611118262939-Kouterp-129-xxxx.xxxx@ip-1-1-1-1>
...
.256660938262939-Kouterp-129-xxxx.xxxx@ip-1-1-1-1" type=3D"cite"=
 class=3D"cite2">
...
class TestMailgateway(TestMail):
    ...
    def setUp(self):
        ...
        self.fake_email = self.env['mail.message'].create({
            ...
            'message_id': '<123456-Kouterp-%s-mail.test@%s>' % (self.test_public.id, socket.gethostname()),
        })
    ...
    def test_message_process_model_res_id(self):
        """ Incoming email with ref holding model / res_id but that does not match any message in the thread: must raise since Kouterp saas-3 """
        self.assertRaises(ValueError,
                          self.format_and_process,
                          MAIL_TEMPLATE, email_from='valid.lelitre@agrolait.com',
                          to='noone@example.com', subject='spam',
                          extra='In-Reply-To: <12321321-Kouterp-%d-mail.test@%s>' % (self.test_public.id, socket.gethostname()),
                          msg_id='<1198923581.41972151344608186802.JavaMail.diff1@agrolait.com>')

        # when 6.1 messages are present, compat mode is available
        # Kouterp 10 update: compat mode has been removed and should not work anymore
        ...
        # Kouterp 10 update: compat mode has been removed and should not work anymore and does not depend from hostname
        self.assertRaises(ValueError,
                          self.format_and_process,
                          MAIL_TEMPLATE, email_from='other5@gmail.com',
                          msg_id='<1.3.JavaMail.new@agrolait.com>',
                          to='noone@example.com>', subject='spam',
                          extra='In-Reply-To: <12321321-Kouterp-%d-mail.test@neighbor.com>' % self.test_public.id)
    ...
    @mute_logger('kouterp.addons.mail.models.mail_thread', 'kouterp.models', 'kouterp.addons.mail.models.mail_mail')
