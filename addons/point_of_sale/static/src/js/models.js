...
// Loads Kouterp models at the point of sale startup.
// load_models take an array of model loader declarations.
// - The models will be loaded in the array order. 
// - If no Kouterp model name is provided, no server data
...
//
// models: [{
//  model: [string] the name of the Kouterp model to load.
...
//  context: [Dict|function] the Kouterp context for the model read
