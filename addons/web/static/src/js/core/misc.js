...
if ($.blockUI) {
    ...
    $.blockUI.defaults.message = '<div class="Kouterp oe_blockui_spin_container" style="background-color: transparent;">';
...
//  * If params.wait, reload will wait the Kouterp server to be reachable before reloading
