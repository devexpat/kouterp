...
/**
 * Implementation of the ``char`` Kouterp field type:
 *
...
/**
 * Implementation of the ``datetime`` Kouterp field type:
 *
...
var FilterGroup = Input.extend(/** @lends instance.web.search.FilterGroup# */{
     ...
     *
     * @param {Kouterp.web.search.Facet} facet
...
var Filter = Input.extend(/** @lends instance.web.search.Filter# */{
    ...
    /**
     * Implementation of the Kouterp filters (button with a context and/or
