...
var ActionManager = Widget.extend({
     ...
     *
     * @param {Widget} widget typically, widgets added are Kouterp.web.ViewManager. The action manager uses the stack of actions to handle the breadcrumbs.
